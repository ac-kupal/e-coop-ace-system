...
const IncentiveAssigned = ({ eventId, member, state, newClaimEntries, claimedIncentiveIds, onAdd, onRemove }: Props) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="p-2 flex-1">
                                <p className="text-xl font-medium">{incentiveAssigned.incentive.itemName}</p>
                            </div>
                            {
                                !satisfied ? <p className="text-sm pr-2">NOT {incentiveAssigned.incentive.claimRequirement}</p> : 
