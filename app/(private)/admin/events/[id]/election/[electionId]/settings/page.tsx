...
const Settings = ({ params }: Props) => {
  ...
  const { elections, isLoading } = getElectionWithPositionAndCandidates({ params });
  ...
  return (
    <div className="space-y-2 p-2">
      ...
      <p className="text-sm p-2">
        You can view this page because you are one of the administrators. This
        privilege grants authorized individuals the ability to access and
        navigate this page, ensuring that only designated administrators can
        view its content and perform administrative tasks.
      </p>
