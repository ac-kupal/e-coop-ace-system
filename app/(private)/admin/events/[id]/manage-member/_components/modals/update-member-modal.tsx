...
const UpdateMemberModal = ({ member, state, onClose, onCancel }: Props) => {
    ...
    const isMemberOnchange =
        memberForm.watch().passbookNumber === member.passbookNumber &&
        memberForm.watch().firstName === member.firstName &&
        memberForm.watch().middleName === member.middleName &&
        memberForm.watch().lastName === member.lastName &&
        memberForm.watch().birthday === member.birthday &&
        memberForm.watch().emailAddress === member.emailAddress &&
        memberForm.watch().contact === member.contact &&
        memberForm.watch().picture === member.picture &&
        memberForm.watch().gender === member.gender;
