...
const EventNavItems = ({ route, eventId }: Props) => {
   ...
   return (
      <Link href={finalPath} className="flex cursor-pointer justify-start space-x-2  hover:scale-105">
         <div className={`flex lg:space-x-2 duration-300  items-center px-2 lg:px-5  ease-in-out ${isCurrentPath ? "text-[#099065] font-bold":"text-foreground/90 "}  hover:bg-non dark:bg-gray-600/20 border-b p-2 rounded-xl`}>
