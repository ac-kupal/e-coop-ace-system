...
const EventNavItems = ({ route}: Props) => {
   ...
   return (
      <Link href={`${path}`} className="flex cursor-pointer justify-start space-x-2">
         <div className={`flex  duration-300  items-center px-2 lg:px-5  ease-in-out ${isCurrentPath ? "  text-[#099065] font-bold":"text-foreground/90 "}   hover:bg-[#17f5af]/30 dark:hover:bg-primary/30 shadow lg:shadow-sm p-2 rounded-xl`}>
