...
const ElectionNavItems = ({ route}: Props) => {
   ...
   return (
      <Link href={`${path}`} className="flex lg:px-5 cursor-pointer justify-start space-x-2">
         <div className={`flex space-x-0 justify-center items-center lg:space-x-2 duration-300 ease-in-out ${isCurrentPath ? "bg-white dark:bg-gradient-to-l dark:to-[#1E1D1E]  dark:from-primary text-primary dark:text-[#17f5af] font-bold":" text-muted-foreground"}
