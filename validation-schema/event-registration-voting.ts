...
export const otpSchema = z.string({invalid_type_error : "otp must be valid string", required_error : "otp is required"}).min(6, "otp must be minimum of 6 digits").max(6, "otp must be maximum of 6 digits")
