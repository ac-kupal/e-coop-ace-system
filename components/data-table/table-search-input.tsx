...
const SearchInput = ({globalFilter,setGlobalFilter}: Props) => {
   ...
   return (
      <Input
         ...
         className="w-full pl-8 border-0 border-b bg-transparent text-accent placeholder:text-accent text-sm md:text-base ring-offset-0 focus-visible:ring-0 focus-visible:ring-offset-0"
      />
   );
};
