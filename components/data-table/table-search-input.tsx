...
const SearchInput = ({globalFilter,setGlobalFilter}: Props) => {
   ...
   return (
      <Input
         ...
         className="w-full pl-8 border-0 border-b border-foreground dark:border-white bg-transparent text-foreground dark:text-white dark:placeholder:text-white   text-sm md:text-base ring-offset-0 focus-visible:ring-0 focus-visible:ring-offset-0"
      />
   );
};
